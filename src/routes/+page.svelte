...
<main>
    ...
    <div class="text">
        <p>
            Toronto has had mixed results in encouraging building new housing
        ...
        <p>
            ...
            metres (approx. a 10-15 minute walk) from these lines. The dropdowns
            allow for selecting between lines and different aspects of TOD and
            it's impact on neighbourhoods, including population, dwelling types,
            and income. The chart has two curves, one for 1996 and one for 2021,
            to compare and show changes over this 25 year period.
        </p>
        <p>
            <select
                id="transit"
