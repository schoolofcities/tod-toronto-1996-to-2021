...
export let textSpanClass = 'absolute px-3 font-medium text-gray-900 -translate-x-1/2 bg-white left-1/2 dark:text-white dark:bg-gray-900 ';
export let innerDivClass = 'absolute px-4 -translate-x-1/2 bg-white left-1/2 dark:bg-gray-900';
